            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Tips</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Donating Platelets? Don't take aspirin for 2 days before your appointment. Learn About Platelet Donations.
						Ask a friend to donate at the same time . You can support each other and do twice as much good!
						Download the Blood Donor App to receive appointment reminders, start your RapidPass and more.</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
