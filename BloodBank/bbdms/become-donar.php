...
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status,district) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status,:district)";
...
<div><select name="district" class="form-control" required>
<?php $sql = "SELECT * from  tbldistrict";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<div><center><input type="submit" name="submit" class="btn btn-primary" value="submit" style="cursor:pointer"></center>
</div>
<br>
